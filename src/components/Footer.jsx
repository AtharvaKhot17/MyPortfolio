      ...
      <div className="footer-content">
        <div className="footer-section contact-info">
          ...
          <div className="contact-details">
            <p>
              ...
              <a href="mailto:atharvakhot1718@gmail.com">atharvakhot1718@gmail.com</a>
            </p>
            <p>
        ...
        <div className="footer-section connect-section">
          ...
          <div className="social-links">
            ...
            <a href="https://www.linkedin.com/in/atharva-khot-8646922ba/" target="_blank" rel="noopener noreferrer" className="social-link">
