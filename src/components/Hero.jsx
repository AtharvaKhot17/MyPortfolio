      ...
      <div className="hero-content">
        <div className="hero-text">
          ...
          <div className="cta-buttons">
            ...
            <a href="/Atharva_Khot_IT_CV.pdf" className="secondary-btn" download>
          ...
          <div className="social-links">
            ...
            <a href="https://www.linkedin.com/in/atharva-khot-8646922ba/" target="_blank" rel="noopener noreferrer" className="social-btn">
